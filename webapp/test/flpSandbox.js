		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#territory1northwindterritoryproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"territory1northwindterritoryproject-display": {
								"semanticObject": "territory1northwindterritoryproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=territory1.northwindterritoryproject",
									"url": sap.ui.require.toUrl("territory1/northwindterritoryproject")
								}
							}
						}
					}
